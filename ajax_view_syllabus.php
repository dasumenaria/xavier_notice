						...
						<tbody>
							...
							<?php echo $i;?>
									...
									<td>
                                       ...
                                       <a class="btn btn-circle btn-xs" Target="_Blank" style="color:#FFF; background-color:#FFB848" href="<?php echo 'syllabus/'.$file;?>">
										<i class="fa fa-eye"></i></a>
                                        &nbsp;				
                                        &nbsp;
									
                                       
										<a class="btn btn-circle btn-xs" style="color:#FFF; background-color:#C30" rel="tooltip" title="Delete"  data-toggle="modal" href="#delete<?php echo $id ;?>"><i class="fa fa-trash"></i></a>
